export const skillTools = [
  ...
  {
    toolName: 'Git',
    toolIcon: 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/git/git-original.svg',
    toolSkill: 'Intermedio',
    toolSkillClass: 'intermediate',
  },
  {
  ...
  {
    toolName: 'Ruby',
    toolIcon: 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/ruby/ruby-original.svg',
    toolSkill: 'Intermedio',
    toolSkillClass: 'intermediate',
  },
  {
